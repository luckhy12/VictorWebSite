	...
	$('.fixed-height').css({'height': $pageHeight+'px'})          // SETTING HEIGHT
	$('.fixed-height-map').css({'height': ($pageHeight-78)+'px'}) // SETTING HEIGHT
	...
	$(function() {
		...
		$('.message .more-button').on('click', function(){
	...
	============================================== */
	$(document).ready(function(){
		$('#login-pan a').on('click', function(){
			var type = $(this).data('section');
			$('.login-button-container a').removeClass('active');
			$('.login-button-container a[data-section="'+type+'"]').addClass('active');
			$('.modal-dialog .box').fadeOut(1);
			$('.modal-dialog #'+type).delay(350).fadeIn();
		});

		$('.login-button-container a').on('click', function(e){
			e.preventDefault();
			$('.login-button-container a').removeClass('active');
			$(this).addClass('active');
			var target = $(this).data('section');
			$('.modal-dialog .box').fadeOut(300);
			$('.modal-dialog #'+target).delay(350).fadeIn();
		});
	});
	...
	/* MORTGAGE CALCULATE
	============================================== */
	$("#mortgage-calc").on('click', function(){
